...
# Default target
.PHONY: all format test build clean test-docker build-docker lint-docker release help
...
# Pushing the tag triggers the GoReleaser workflow (.github/workflows/release.yml).
...
ifndef VERSION
	...
	echo "Done. Watch: https://github.com/idesyatov/http-runner/actions"
...
help:
	...
	@echo "                      (example: make release VERSION=v1.4.0)"
